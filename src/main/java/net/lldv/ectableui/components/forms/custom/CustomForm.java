package net.lldv.ectableui.components.forms.custom;
...
import net.lldv.ectableui.components.forms.FormHandler;
...
public class CustomForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(ECTableUI.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
