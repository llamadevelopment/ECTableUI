package net.lldv.ectableui.components.language;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        ECTableUI.getInstance().saveResource("messages.yml");
        Config m = new Config(ECTableUI.getInstance().getDataFolder() + "/messages.yml");
